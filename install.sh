...
echo "=========================================================="
echo " 🟢 جسر Gemini يعمل على البورت:  8123 (http://127.0.0.1:8123/v1)"
echo " 🟣 جسر Codex يعمل على البورت:   8124 (http://127.0.0.1:8124/v1)"
echo " 🌐 لوحة التحكم تعمل على البورت: 8444 (http://127.0.0.1:8444)"
echo "----------------------------------------------------------"
echo " 📌 أوامر الاستخدام السريعة:"
echo "   - حسابات Gemini: ag (أو ag list), agusage, ag 1, ag 2, ag add"
echo "   - حسابات Codex:  cx (أو cx list), cusage, c 1, c 2, c 3, cx add"
echo "=========================================================="
